                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center space-x-4 ml-auto">
                        <div className="hidden md:flex space-x-4">
                            <Link to="/home" className="relative text-white px-2 py-2 rounded-md text-lg font-medium group cursor-pointer">
                                Dashboard
                        ...
                        <div className="flex items-center space-x-4 ml-4">
                            <button className="relative p-2 text-white hover:text-green-700">
                                <FaBell className="text-2xl" />
                                {/* Notification Badge */}
                                <span className="absolute top-0 right-0 w-2.5 h-2.5 bg-red-600 rounded-full"></span>
                            </button>
                            <Link to="/profile" className="p-2 text-white hover:text-green-700">
